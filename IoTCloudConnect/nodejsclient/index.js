...
const mqttDeviceDemo = (
    ...
    const projectId = `cmpe-181-hw1-rbiesty`;
    //const deviceId = `cmpe181devRB`;
    const registryId = `CMPE181IoTRB`;
    const region = `us-central1`;
    //const algorithm = `RS256`;
    // const privateKeyFile = /Users/Ryther/GoogleCloud/certs/rsa_private.pem';
    //const serverCertFile = /Users/Ryther/GoogleCloud/certs/roots.pem';
...
const { argv } = require(`yargs`)
    .options({
        ...
        privateKeyFile: {
            default: '/Users/Ryther/GoogleCloud/certs/rsa_private.pem',
        ...
        serverCertFile: {
            default: '/Users/Ryther/GoogleCloud/certs/roots.pem',

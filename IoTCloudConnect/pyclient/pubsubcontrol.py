...
#usage: python3 gcpsub.py cmpe-181-hw1-rbiesty CMPE181RB-subscription
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description=__doc__,
        formatter_class=argparse.RawDescriptionHelpFormatter,
    )
    parser.add_argument("--project_id", type=str, default='cmpe-181-hw1-rbiesty', help="Google Cloud project ID")
    parser.add_argument("--subscription_name", type=str, default='CMPE181RB-subscription', help="Pub/Sub subscription name")
    parser.add_argument("--topic_name", type=str, default='CMPEIoTdeviceRB', help="topic name")
